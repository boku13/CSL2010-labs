...
class TestPhoneBook(unittest.TestCase):
    ...
    def test_delete_nonexistent_contact(self):
        # print(self.phone_book.compute_hash("Jemimah"))
        # print(self.phone_book.compute_hash("jessica"))
        print(self.phone_book.compute_hash("Rodriguez")) 
        print(self.phone_book.compute_hash("Akshay"))
        # print(self.phone_book.compute_hash("Trivedi")) 
        ...
        for contacts in initial_contacts:
            print(contacts.name)
        ...
        for contacts in contacts_after_delete:
            print("bruh")
            print(contacts.name)
